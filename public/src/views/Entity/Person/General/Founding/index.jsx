    ...
    <Paper className={styles.card} title={t('funding')}>
      ...
      <Container className={styles.container}>
        <div className={styles.bar}>
          <BorderLinearProgress variant="determinate" value={reach} color="primary" />
        </div>
        <Typography className={styles.funded} disabled variant="h3" color="primary">
          {reach}$
        </Typography>
        <Typography className={styles.goal} disabled variant="h5" color="primary">
          {t('funding_goal', { goal })}
        </Typography>
        <Typography className={styles.progression} disabled variant="h4" color="primary">
          {percentage()}%
        </Typography>
