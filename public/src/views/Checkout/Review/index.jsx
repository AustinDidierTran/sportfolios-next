...
import { getCartItems } from '../../../utils/stripe';
import { formatPrice } from '../../../utils/stringFormats';
import { checkout, createRefund } from '../../../actions/service/stripe';
...
export default function Review() {
  ...
  const getTotal = () => {
    const total = items.reduce((prevTotal, item) => (prevTotal += item.amount), 0);
    setTotal(total);
  };
      ...
      <div className={styles.view}>
        ...
        <div className={styles.content}>
          {items.map((item, index) => {
            return <CustomCard items={{ ...item, setItems }} type={CARD_TYPE_ENUM.INVOICE} key={index} />;
          })}
        </div>
