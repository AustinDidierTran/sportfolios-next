...
export default function Customer() {
  ...
  return (
    <div>
      ...
      <Button onClick={attachPaymentMethod}>Attach Payment Method to customer</Button>
      <Button onClick={detachPaymentMethod}>Detach Payment Method from customer</Button>
