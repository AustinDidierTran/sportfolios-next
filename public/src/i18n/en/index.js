...
export default {
  translations: {
    ...
    added_to_roster_description:
      "Notifications sent when someone add one of your people to a roster",
    added_to_roster_notif_description:
      "Somebody added you to the {{teamName}} team",
    ...
    become_member_of:
      "Become a member of {{organizationName}}. Expiration date: {{expirationDate}}",
    ...
    by_getting_a_new_link_the_old_one_will_expires:
      "By getting a new link, the old one will expire",
    by: "By",
    ...
    import_your_excel_sheet_with_all_your_members:
      "Import your excel sheet with all your members",
    import: "Import",
    in_cart: "In cart",
    inclusive: "Inclusive",
    ...
    invalid_alias:
      "The alias can only contain alphanumeric characters and dots",
    ...
    link_has_been_copied_and_will_expire:
      "Link has been copied and will expire on {{expireDate}}",
    ...
    members_report_description:
      "This report allows you to access your members' list at a certain date in the past",
    members: "Members",
    ...
    sales_report_description:
      "This report allows you to see your sales at a certain date",
    sales: "Sales",
    ...
    score_submission_conflict_notif_description:
      "A game from the event {{eventName}} has score conflicts.",
    ...
    team_player_role_error:
      "There must always be at least one coach, captain or assistant captain in the team.",
    ...
    this_organization_has_no_memberships_available:
      "This organization has no memberships available",
    ...
    to_invite_people_to_your_roster_share_the_invite_link:
      "To invite people to join your team, share the invite link",
    to_see_your_receipt:
    ...
    valid_percentage_values:
      "Value needs to be between 0 and 100 with 4 decimals max",
    ...
    with_taxes_the_total_for_a_player_is:
      "With taxes, the total for a player is {{total}}$",
    with_taxes_the_total_for_a_team_is:
      "With taxes, the total for a team is {{total}}$",
    ...
    you_are_not_in_any_of_these_teans:
      "You cannot submit a result since you are not in any of these teams",
    ...
    you_can_go_to_your_organization_settings_to_add_one:
      "You can go to your organization settings to add one",
    ...
    you_need_to_have_a_membership_available:
      "You need to have a membership available",
