...
export default {
  translations: {
    ...
    delete: {
      ...
      delete_participants: 'Remove participants',
    ...
    facebook: {
      add_email: 'Add a Facebook account',
    ...
    auth: {
      ...
      errors: {
        ...
        invalid_password: 'Invalid password. It must have between 8 and 24 characters',
      ...
      forgot_password: 'Forgot password?',
      forgotten_password: 'Enter your email and we will send you a recovery code.',
      send_recovery_code: 'Send recovery code',
      new_code: 'New code',
      new_code_sent: 'New code sent',
      recover_password: 'A recovery code has been sent to {{email}}. Please retrieve it to reset your password',
      next: 'Next',
      ...
      footer: {
        ...
        sportfolios_confirm: 'of Sportfolios and you confirm you read the ',
        privacy_policy: 'Privacy Policy',
        of_sportfolios: 'of Sportfolios.',
      },
    },
    ...
    reports: {
      ...
      payouts: {
        title: 'Payouts',
        description: 'This report displays payouts, their transaction and their deposit time',
      },
      ...
      headers: {
        members: {
          ...
          emergency_surname: 'Emergency Surname',
          emergency_phone_number: 'Emergency Phone Number',
          medical_conditions: 'Medical Conditions',
          heard_organization: 'Heard Organization',
