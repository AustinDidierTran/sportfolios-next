...
export default {
  translations: {
    ...
    add: {
      ...
      added_to_roster_description: 'Notifications sent when someone add you to a roster',
      ...
      added_to_team_notif_description: 'Somebody added you to the {{teamName}} team',
