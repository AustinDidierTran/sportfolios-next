...
export default {
  translations: {
    ...
    add: {
      ...
      added_to_event_description: 'Notification envoyée lorsque vous êtes ajouté à un événement',
      added_to_event_notif_description: "{{teamName}} vous a ajouté à l'événement {{eventName}} ",
      added_to_event_notif_title: 'Vous avez été ajouté à un événement',
      added_to_event: 'Ajouté à un événement',
      added_to_team_description: 'Notification envoyée lorsque vous êtes ajouté à une équipe',
      added_to_team_notif_description: "Vous avez été ajouté à l'équipe {{teamName}}",
    ...
    delete: {
      ...
      delete_this_item_from_shop: 'Êtes-vous certain de vouloir supprimer cet article de votre magasin?',
      ...
      delete_participants: 'Supprimer des participants',
      delete: 'Supprimer',
    },
    description: {
    ...
    no: {
      ...
      no_email_provided: 'Aucun courriel fourni',
      ...
      no_time_yet: 'Pas de temps',
      no_date_yet: 'Pas de date',
      no_field_yet: 'Pas de terrain',
      no_users_found: 'Aucun utilisateur trouvé',
      no: 'non',
      none_feminine: 'Aucune',
      none: 'Aucun',
      not_specified: 'Non spécifié',
      no_nickname: 'Aucun surnom',
    },
    partner: {
      partner: 'Partenaire',
    ...
    click_to_add_game: "Cliquez sur un '+'",
    ...
    auth: {
      ...
      errors: {
        empty_code: 'Le code ne peut être vide',
        invalid_email: 'Courriel invalide',
        invalid_password: 'Mot de passe invalide. Il doit contenir entre 8 et 24 caractères',
      ...
      signup_with_email: 'Utiliser une adresse e-mail',
      login: 'Connexion',
      ...
      footer: {
        ...
        sportfolios_confirm: 'de Sportfolios et tu confirmes avoir lu les',
        privacy_policy: 'Politiques de confidentialité',
        of_sportfolios: 'de Sportfolios.',
      },
    },
    ...
    reports: {
      headers: {
        members: {
          ...
          gender: 'Genre',
          address: 'Adresse',
          emergency_name: 'Prénom (Contact urgence)',
          emergency_surname: 'Nom de famille (Contact urgence)',
          emergency_phone_number: 'Numéro de téléphone (Contact urgence)',
          medical_conditions: 'Conditions médicales',
          heard_organization: 'Organization entendue',
          getting_involved: "S'impliquer",
          frequented_school: 'École fréquentée',
          job_title: 'Emploi',
          employer: 'Employeur',
        },
        payouts: {
          automatic_payout_id: 'Automatic Payout Id',
          automatic_payout_effective_at: 'Automatic Payout Effective At',
          ...
          description: 'Description',
          charge_id: 'Charge Id',
          charge_created: 'Charge Created at',
      ...
      payouts: {
        title: 'Dépôts',
        description:
          'Ce rapport vous permet de voir tous les dépôts, les transactions ainsi que leur date de versement',
      },
      report_created: 'Rapport créé',
      report: 'Rapport',
      reports: 'Rapports',
      members: { title: 'Rapport de membre' },
      sales: { title: 'Rapport de vente' },
      transaction_type: {
        free: 'Gratuit',
        payment: 'Paiement',
        refund: 'Remboursement',
    ...
    sizes_enum_m: 'Moyen',
    sizes_enum_sm: 'Petit',
    sizes_enum_xl: 'T-Grand',
    sizes_enum_xs: 'T-Petit',
    sizes_enum_xxl: '2T-Grand',
    sizes_enum_xxs: '2T-Petit',
    sizes_enum_xxxl: '3T-Grand',
    sizes_enum_xxxs: '3T-Petit',
    sizes: 'Grandeurs',
    skip: 'Passer',
    soccer: 'Soccer',
