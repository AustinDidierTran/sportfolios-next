...
export default {
  translations: {
    ...
    added_to_roster_description:
      "Notification envoyée lorsqu'une de vos personnes est ajoutée à un alignement",
    added_to_roster_notif_description:
      "Quelqu'un vous a ajouté à l'équipe {{teamName}}",
    ...
    become_member_of:
      "Devenir membre de {{organizationName}}. Date d'expiration: {{expirationDate}}",
    ...
    by_getting_a_new_link_the_old_one_will_expires:
      "En générant un nouveau lien, l'ancien deviendra invalide.",
    by: "Par",
    ...
    delete_report_confirmation:
      "Êtes-vous certain de vouloir supprimer ce rapport?",
    delete_report: "Supprimer le rapport",
    delete_tax_confirmation:
      "Êtes-vous certain de vouloir supprimer cette taxe?",
    ...
    import_your_excel_sheet_with_all_your_members:
      "Importez le fichier excel avec tous vos membres",
    import: "Importer",
    ...
    invalid_alias:
      "L'alias peut seulement contenir des caractères alphanumérique et des points",
    invalid_coupon: "Coupon invalide",
    invalid_date_it_should_follow:
      "Date invalide. Elle devrait suivre: yyyy-mm-dd",
    invalid_date: "Date invalide",
    invalid_email: "Courriel invalide.",
    invalid_file_format:
      "Format de fichier invalide. Seulement les fichiers csv sont acceptés.",
    ...
    link_has_been_copied_and_will_expire:
      "Le lien a été copié et expirera le {{expireDate}}",
    ...
    members_report_description:
      "Ce rapport vous permet d'accéder à la liste de vos membres à une date précise",
    members: "Membres",
    ...
    no_admins_with_bank_account:
      "Aucun administrateurs avec un compte bancaire",
    ...
    no_owner_free_payment_option:
      "Pas de propriétaire, option de paiement gratuite",
    ...
    sales_report_description:
      "Ce rapport vous permet d'accéder à toutes vos ventes à une date précise",
    sales: "Ventes",
    ...
    score_submission_conflict_notif_description:
      "Une partie de l'événement {{eventName}} a des conflits de score.",
    ...
    this_coupon_is_only_good_once:
      "Ce coupon est valide pour une utilisation seulement",
    this_organization_has_no_events: "Cette organisation n'a pas d'événement",
    this_organization_has_no_memberships_available:
      "Cette organisation n'a pas d'affilitations disponibles",
    ...
    valid_percentage_values:
      "La valeur doit être entre 0 et 100 avec 4 décimales maximum",
    ...
    with_taxes_the_total_for_a_player_is:
      "Avec les taxes, le total pour un joueur est {{total}}$",
    with_taxes_the_total_for_a_team_is:
      "Avec les taxes, le total pour une équipe est {{total}}$",
    ...
    you_need_to_have_a_membership_available:
      "Une affiliation doit être disponible",
