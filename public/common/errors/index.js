export const ERROR_ENUM = {
  ...
  REMOVE_LAST_CAPTAIN: 'Team must have at least one coach, captain or assistant captain',
  REMOVE_PAID_PLAYER: 'Not allowed to remove player that has paid',
  TOKEN_EXPIRED: 'Token has expired',
  TOKEN_IS_INVALID: 'Token is invalid,',
  UNCONFIRMED_EMAIL: 'Unconfirmed email',
  UNREGISTRATION_ERROR: 'There was an error with your unregistration or the refund',
