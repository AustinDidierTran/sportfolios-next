...
const Event = loadable(() => import('../../public/src/views/Entity/Event/editRosters'));
...
export default function EntityRoute() {
  ...
  const { response, isLoading } = useApiRoute(formatRoute('/api/entity/editRosters', null, { id }), {
    defaultValue: {},
  });
  ...
  if (isLoading) {
    return (
      <>
        <Head>
          <meta property="og:title" content={t('metadata.[id].editRosters.title')} />
          <meta property="og:description" content={t('metadata.[id].editRosters.description')} />
          <meta
            property="og:image"
