...
const Event = loadable(() => import('../../public/src/views/Entity/Event/schedule.jsx'));
...
export default function EntityRoute() {
  ...
  if (isLoading) {
    return (
      <>
        <Head>
          <meta property="og:title" content={t('metadata.[id].schedule.title')} />
          <meta property="og:description" content={t('metadata.[id].schedule.description')} />
          <meta
            property="og:image"
