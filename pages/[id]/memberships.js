...
const Organization = loadable(() => import('../../public/src/views/Entity/Organization/memberships.jsx'));
...
export default function EntityRoute() {
  ...
  const { response, isLoading } = useApiRoute(formatRoute('/api/entity/membershipsTab', null, { id }), {
    defaultValue: {},
  });
  ...
  if (isLoading) {
    return (
      <>
        <Head>
          <meta property="og:title" content={t('metadata.[id].memberships.title')} />
          <meta property="og:description" content={t('metadata.[id].memberships.description')} />
          <meta
            property="og:image"
