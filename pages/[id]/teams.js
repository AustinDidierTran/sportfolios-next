...
const Event = loadable(() => import('../../public/src/views/Entity/Event/teams'));
...
export default function EntityRoute() {
  ...
  const { response, isLoading } = useApiRoute(formatRoute('/api/entity/teams', null, { id }), {
    defaultValue: {},
  });
  ...
  if (isLoading) {
    return (
      <>
        <Head>
          <meta property="og:title" content={t('metadata.[id].teams.title')} />
          <meta property="og:description" content={t('metadata.[id].teams.description')} />
          <meta
            property="og:image"
